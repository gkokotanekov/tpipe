...
#        self.long = self.params[self.profile]['long'] #commented by GDK
#        self.lat = self.params[self.profile]['lat'] #commented by GDK
...
#            print ti[i]
        ...
        self.rawdata = newda
#        flags[:,:,:,:] = False #GDK, to disregard flagged, i.e. consider nothing is flagged, analyse whole data
...
#        if trackon[0][0] == 118:
#            where_flagged_tr = n.where(data[118, :,:,:].mask == True)
#            print 'where_flagged_tr', where_flagged_tr
#            print 'flagged', data[118, where_flagged_tr]
#            print 'flagged', data[118, where_flagged_tr].data, 'data'
